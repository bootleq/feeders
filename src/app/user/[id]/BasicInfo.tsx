...
const dialogCls = [
  ...
  'z-[2000] w-fit p-4 bg-gradient-to-br from-stone-50 to-slate-200 md:rounded-lg md:shadow-lg',
      ...
      {waitingActivate &&
        <dialog ref={activateDialogRef} role='dialog' aria-modal className={dialogCls}>
          ...
          <form onSubmit={onActivate} className='flex flex-col items-center justify-center w-fit mx-auto mb-2'>
            <button className='btn py-2 flex items-center hover:bg-white mb-1 hover:ring-inset hover:ring-1 hover:ring-slate-400' disabled={activating}>
              {activating ?
            ...
            <button type='button' onClick={cancelActivate} className='btn py-2 flex items-center hover:bg-white self-stretch hover:ring-inset hover:ring-1 hover:ring-slate-400'>
