/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: db3c918b6b99f49b422c95591d48fe89)
...
declare namespace Cloudflare {
	interface Env {
		...
		DB: D1Database;
		WORKER_SELF_REFERENCE: Fetcher /* feeders */;
		ASSETS: Fetcher;
	}
}
